...
const RecipeDetailCard = ({ recipe, id }) => {
  ...
  const readInstructions = () => {
    if ("speechSynthesis" in window) {
      ...
      utterance.text =
        recipe.instructions?.join(". ") || "No instructions available.";
          ...
          {openTextArea ? (
            <div className="flex-1">
              ...
              <button
                ...
                className="w-20 bg-green-400 hover:bg-green-500 text-black dark:text-white font-bold m-2 rounded"
              >
                Submit
              </button>
              <button
                ...
                className="w-20 bg-red-400 hover:bg-red-500 text-black dark:text-white font-bold m-2 rounded"
              >
                Close
              </button>
            </div>
            ...
            <button
              ...
              className="w-12 mb-4 bg-blue-400 hover:bg-blue-500 text-black dark:text-white font-bold rounded"
            >
              Edit
            </button>
          )}
