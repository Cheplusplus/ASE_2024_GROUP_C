...
/**
 * LayoutRecipesGrid
 * @description A component that displays a grid of 8 recipes in a responsive layout.
 * @returns A ReactElement representing the LayoutRecipesGrid component.
 */
const LayoutRecipesGrid = async () => {
  try {
    const url = process.env.NEXT_PUBLIC_API_URL || "http://localhost:3000";
    const res = await fetch(
      `${url}/api/recipe?limit=8`,
      { cache: "force-cache" },
      {
